...
let ALLOWED_NAMES = ['bunnychan','bunny'];
let LEVEL1_HINT = '💡 indice : ça commence par « bunny »... 🐰';
...
const QUIZ_QUESTIONS = [
  ...
  "Où dans le monde t'enfuirais-tu avec moi demain ?",
  "Le petit truc chez moi qui te fait toujours sourire ?",
...
const INSTRUCTIONS = {
  1: {
    title: 'Chuchote-moi un mot',
    body: `
      <p>Un quiz du petit nom secret — dis-le comme moi seul je le dis ♥</p>
      <ul>
        <li>Tape le petit nom que je te donne dans la case</li>
        <li>Tu as <strong>3 essais</strong> — ton cœur connaît la réponse</li>
        <li>Appuie sur <strong>Dis-le-moi</strong> ou sur Entrée pour valider</li>
      </ul>
    `
  },
  2: {
    title: 'Mémoire à Deux',
    body: `
      <p>Un jeu de cartes à retourner — chaque paire trouvée débloque un souvenir de nous ✿</p>
      <ul>
        <li>Touche une carte pour la retourner et voir son symbole</li>
        <li>Touche une deuxième carte — si les symboles correspondent, elles restent retournées</li>
        <li>Sinon, elles se retournent à nouveau. Souviens-toi où elles étaient !</li>
  ...
  3: {
    title: 'Puzzle Photo',
    body: `
      <p>Une photo de nous, toute mélangée — glisse chaque pièce à sa place ✿</p>
      <ul>
        <li><strong>Glisse</strong> une pièce avec ta souris ou ton doigt</li>
        <li>Quand tu déposes une pièce <strong>près de son bon endroit</strong>, elle s'aimante</li>
        <li>Les pièces posées prennent un doux <strong>reflet vert</strong> et se bloquent</li>
        <li>Utilise <strong>l'aperçu cible</strong> sur le côté comme référence</li>
        <li>Touche <strong>↻ mélanger</strong> pour tout recommencer</li>
      </ul>
    `
  },
  4: {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Les cœurs tombent lentement et sont bien gros — faciles à toucher ✿</li>
      </ul>
    `
  },
  5: {
    ...
    body: `
      <p>Relie les étoiles brillantes dans l'ordre pour dessiner notre forme ✦</p>
      <ul>
        ...
        <li>Une ligne scintillante se trace entre chaque paire d'étoiles</li>
...
const LOVE_LETTER = `Ma chère [NAME],

J'ai fait tout ça — le chemin, les jeux, ces petits puzzles un peu fous — pour une seule raison. Te dire ce que j'oublie parfois de dire à voix haute.

Tu es mon chapitre préféré de chaque jour. Les jours calmes, les jours bruyants, ceux où j'oublie mes clés et où tu ris de moi quand même.

Merci d'être à moi, bunny chan.
...
const GALLERY = [
  ...
  { src: 'assets/images/memories/memory-3.jpeg', caption: 'ce rire qui n\'appartient qu\'à toi' },
  { src: 'assets/images/memories/memory-4.jpeg', caption: 'ma vue préférée' },
  { src: 'assets/images/memories/memory-5.jpeg', caption: 'chaque petit instant' },
  { src: 'assets/images/memories/memory-6.jpeg', caption: 'encore tant de chemin à faire ✦' },
];
